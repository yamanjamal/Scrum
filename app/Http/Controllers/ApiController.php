...
class ApiController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function restoredsussesfully($data='')
    {
       return $this->baseservice->sendResponse($data,'data restored sussesfully');
    }
    ...
    {
        return $this->baseservice->sendResponse($data,'data forcedeleted sussesfully');
    }
    /**
     * Display a listing of the resource.
     *
